...
- Executable metadata schema assets stay under `docs/schema/`; generated README screenshots stay under `docs/assets/screenshots/`; issue-specific evidence stays under `docs/verification/` and is not published.
...
4. Link durable source artifacts such as `conf/`, `internal/`, `resources/`, `docs/architecture/`, and `docs/schema/` instead of duplicating their contracts in the Wiki.
