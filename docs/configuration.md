...
The de-facto configuration list is located in [config.go](../internal/config/config.go).
...
- [Observability](observability.md): metrics, traces, health checks and Grafana.
