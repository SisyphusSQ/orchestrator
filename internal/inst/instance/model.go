...
// Package instance defines the canonical database instance domain model.
package instance
...
// Group replication roles and states mirror performance_schema.replication_group_members.
const (
...
// IsMaxScale reports whether the instance represents a MaxScale binlog server.
func (instance *Instance) IsMaxScale() bool {
...
// ApplyFlavorName derives FlavorName from the instance version metadata.
func (instance *Instance) ApplyFlavorName() {
	instance.applyFlavorName()
}

// SetMasterExecutedGtidSet stores the master's executed GTID set discovered for this instance.
func (instance *Instance) SetMasterExecutedGtidSet(value string) {
	instance.masterExecutedGtidSet = value
}

// MasterExecutedGtidSet returns the master's executed GTID set discovered for this instance.
func (instance *Instance) MasterExecutedGtidSet() string {
	return instance.masterExecutedGtidSet
}
