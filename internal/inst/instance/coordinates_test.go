...
func TestBinlogCoordinates(t *testing.T) {
	c1 := instmodel.BinlogCoordinates{LogFile: "mysql-bin.00017", LogPos: 104}
	c2 := instmodel.BinlogCoordinates{LogFile: "mysql-bin.00017", LogPos: 104}
	c3 := instmodel.BinlogCoordinates{LogFile: "mysql-bin.00017", LogPos: 5000}
	c4 := instmodel.BinlogCoordinates{LogFile: "mysql-bin.00112", LogPos: 104}
...
func TestBinlogPrevious(t *testing.T) {
	...
	c2 := instmodel.BinlogCoordinates{LogFile: "mysql-bin.00100", LogPos: 104}
	...
	c3 := instmodel.BinlogCoordinates{LogFile: "mysql.00.prod.com.00100", LogPos: 104}
	...
	c4 := instmodel.BinlogCoordinates{LogFile: "mysql.00.prod.com.00000", LogPos: 104}
...
func TestBinlogCoordinatesAsKey(t *testing.T) {
	m := make(map[instmodel.BinlogCoordinates]bool)

	c1 := instmodel.BinlogCoordinates{LogFile: "mysql-bin.00017", LogPos: 104}
	c2 := instmodel.BinlogCoordinates{LogFile: "mysql-bin.00022", LogPos: 104}
	c3 := instmodel.BinlogCoordinates{LogFile: "mysql-bin.00017", LogPos: 104}
	c4 := instmodel.BinlogCoordinates{LogFile: "mysql-bin.00017", LogPos: 222}
