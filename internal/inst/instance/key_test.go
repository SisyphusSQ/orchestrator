...
var key1 = instmodel.InstanceKey{Hostname: "host1", Port: 3306}
var key2 = instmodel.InstanceKey{Hostname: "host2", Port: 3306}
var key3 = instmodel.InstanceKey{Hostname: "host3", Port: 3306}

func TestInstanceKeyEquals(t *testing.T) {
	i1 := instmodel.Instance{
...
func TestNewResolveInstanceKey(t *testing.T) {
	{
		i, err := instresolve.NewInstanceKey("127.0.0.1", 3308)
		test.S(t).ExpectNil(err)
		test.S(t).ExpectEquals(i.Hostname, "127.0.0.1")
		test.S(t).ExpectEquals(i.Port, 3308)
	}
	{
		_, err := instresolve.NewInstanceKey("", 3309)
		test.S(t).ExpectNotNil(err)
	}
	{
		i, err := instresolve.NewInstanceKey("127.0.0.1", 0)
		test.S(t).ExpectNil(err)
...
func TestParseResolveInstanceKey(t *testing.T) {
	{
		key, err := instresolve.ParseInstanceKey("myhost:1234")
		test.S(t).ExpectNil(err)
		test.S(t).ExpectEquals(key.Hostname, "myhost")
		test.S(t).ExpectEquals(key.Port, 1234)
	}
	{
		key, err := instresolve.ParseInstanceKey("myhost")
		test.S(t).ExpectNil(err)
		test.S(t).ExpectEquals(key.Hostname, "myhost")
		test.S(t).ExpectEquals(key.Port, 3306)
	}
	{
		key, err := instresolve.ParseInstanceKey("10.0.0.3:3307")
		test.S(t).ExpectNil(err)
		test.S(t).ExpectEquals(key.Hostname, "10.0.0.3")
		test.S(t).ExpectEquals(key.Port, 3307)
	}
	{
		key, err := instresolve.ParseInstanceKey("10.0.0.3")
		test.S(t).ExpectNil(err)
		test.S(t).ExpectEquals(key.Hostname, "10.0.0.3")
		test.S(t).ExpectEquals(key.Port, 3306)
	}
	{
		key, err := instresolve.ParseInstanceKey("[2001:db8:1f70::999:de8:7648:6e8]:3308")
		test.S(t).ExpectNil(err)
		test.S(t).ExpectEquals(key.Hostname, "2001:db8:1f70::999:de8:7648:6e8")
		test.S(t).ExpectEquals(key.Port, 3308)
	}
	{
		key, err := instresolve.ParseInstanceKey("::1")
		test.S(t).ExpectNil(err)
		test.S(t).ExpectEquals(key.Hostname, "::1")
		test.S(t).ExpectEquals(key.Port, 3306)
	}
	{
		key, err := instresolve.ParseInstanceKey("0:0:0:0:0:0:0:0")
		test.S(t).ExpectNil(err)
		test.S(t).ExpectEquals(key.Hostname, "0:0:0:0:0:0:0:0")
		test.S(t).ExpectEquals(key.Port, 3306)
	}
	{
		_, err := instresolve.ParseInstanceKey("[2001:xxxx:1f70::999:de8:7648:6e8]:3308")
		test.S(t).ExpectNotNil(err)
	}
	{
		_, err := instresolve.ParseInstanceKey("10.0.0.4:")
		test.S(t).ExpectNotNil(err)
	}
	{
		_, err := instresolve.ParseInstanceKey("10.0.0.4:5.6.7")
		test.S(t).ExpectNotNil(err)
	}
}
...
func TestNewResolveInstanceKeyStrings(t *testing.T) {
	{
		i, err := instresolve.NewInstanceKeyStrings("127.0.0.1", "3306")
		test.S(t).ExpectNil(err)
		test.S(t).ExpectEquals(i.Hostname, "127.0.0.1")
		test.S(t).ExpectEquals(i.Port, 3306)
	}
	{
		_, err := instresolve.NewInstanceKeyStrings("127.0.0.1", "")
		test.S(t).ExpectNotNil(err)
	}
	{
		_, err := instresolve.NewInstanceKeyStrings("127.0.0.1", "3306x")
		test.S(t).ExpectNotNil(err)
	}
}
...
func TestInstanceKeyValid(t *testing.T) {
	...
	i, err := instresolve.ParseInstanceKey("_:3306")
	test.S(t).ExpectNil(err)
	test.S(t).ExpectFalse(i.IsValid())
	i, err = instresolve.ParseInstanceKey("//myhost:3306")
	test.S(t).ExpectNil(err)
	test.S(t).ExpectFalse(i.IsValid())
}
...
func TestIsIPv4(t *testing.T) {
	...
	{
		k, _ := instresolve.ParseRawInstanceKey("mysql-server-1:3306")
		test.S(t).ExpectFalse(k.IsIPv4())
	}
	{
		k, _ := instresolve.ParseRawInstanceKey("mysql-server-1")
		test.S(t).ExpectFalse(k.IsIPv4())
	}
	{
		k, _ := instresolve.ParseRawInstanceKey("my.sql.server.1")
		test.S(t).ExpectFalse(k.IsIPv4())
	}
	{
		k, _ := instresolve.ParseRawInstanceKey("mysql-server-1:3306")
	...
	{
		k, _ := instresolve.ParseRawInstanceKey("127.0.0:3306")
		test.S(t).ExpectFalse(k.IsIPv4())
	}
	{
		k, _ := instresolve.ParseRawInstanceKey("127::0::0::1:3306")
		test.S(t).ExpectFalse(k.IsIPv4())
	}
	{
		k, _ := instresolve.ParseRawInstanceKey("127.0.0.1:3306")
	...
	{
		k, _ := instresolve.ParseRawInstanceKey("127.0.0.1")
		test.S(t).ExpectTrue(k.IsIPv4())
	}
}
