...
// Package analysis owns replication failure analysis and its history.
package analysis
...
func NewInstanceAnalysis(instanceKey *instmodel.InstanceKey, analysis AnalysisCode) *InstanceAnalysis {
...
type ReplicationAnalysis struct {
	AnalyzedInstanceKey                       instmodel.InstanceKey
	AnalyzedInstanceMasterKey                 instmodel.InstanceKey
	ClusterDetails                            instcluster.ClusterInfo
	AnalyzedInstanceDataCenter                string
	AnalyzedInstanceRegion                    string
	AnalyzedInstancePhysicalEnvironment       string
	AnalyzedInstanceBinlogCoordinates         instmodel.BinlogCoordinates
	IsMaster                                  bool
	...
	Replicas                                  instmodel.InstanceKeyMap
	SlaveHosts                                instmodel.InstanceKeyMap // for backwards compatibility. Equals `Replicas`
...
func (analysis *ReplicationAnalysis) ReadReplicaHostsFromString(replicaHostsString string) error {
	...
	return instresolve.ReadCommaDelimitedList(&analysis.Replicas, replicaHostsString)
}
