...
var (
	accessDeniedCounter         = observability.NewCounter("orchestrator_instance_access_denied_total", "instance.access_denied events")
	readTopologyInstanceCounter = observability.NewCounter("orchestrator_instance_read_topology_total", "instance.read_topology events")
...
func logReadTopologyInstanceError(instanceKey *instmodel.InstanceKey, hint string, err error) error {
	if err == nil {
		return nil
	}
...
func readReplicationTLSStatusFromShowReplicaRow(instance *instmodel.Instance, m modeldomain.DynamicRow) {
	instance.ReplicationSSLCAFile = m.GetStringD(mysqlquery.Query(instance.Version, mysqlquery.ReplicaStatusSSLCAFile), "")
	instance.ReplicationSSLCAPath = m.GetStringD(mysqlquery.Query(instance.Version, mysqlquery.ReplicaStatusSSLCAPath), "")
	instance.ReplicationSSLCert = m.GetStringD(mysqlquery.Query(instance.Version, mysqlquery.ReplicaStatusSSLCert), "")
	instance.ReplicationSSLCipher = m.GetStringD(mysqlquery.Query(instance.Version, mysqlquery.ReplicaStatusSSLCipher), "")
	instance.ReplicationSSLCRLFile = m.GetStringD(mysqlquery.Query(instance.Version, mysqlquery.ReplicaStatusSSLCRLFile), "")
	instance.ReplicationSSLCRLPath = m.GetStringD(mysqlquery.Query(instance.Version, mysqlquery.ReplicaStatusSSLCRLPath), "")
	instance.ReplicationSSLKey = m.GetStringD(mysqlquery.Query(instance.Version, mysqlquery.ReplicaStatusSSLKey), "")
	instance.ReplicationTLSVersion = m.GetStringD(mysqlquery.Query(instance.Version, mysqlquery.ReplicaStatusTLSVersion), "")
	instance.ReplicationTLSCiphersuites = m.GetStringD(mysqlquery.Query(instance.Version, mysqlquery.ReplicaStatusTLSCipherSuites), "")
	instance.ReplicationSourcePublicKeyPath = m.GetStringD(mysqlquery.Query(instance.Version, mysqlquery.ReplicaStatusPublicKeyPath), "")

	if v := m.GetStringD(mysqlquery.Query(instance.Version, mysqlquery.ReplicaStatusSSLVerifyServerCert), ""); v != "" {
	...
	gpk := m.GetStringD(mysqlquery.Query(instance.Version, mysqlquery.ReplicaStatusGetSourcePublicKey), "")
	if gpk != "" {
...
// backend.
func ReadTopologyInstance(instanceKey *instmodel.InstanceKey) (*instmodel.Instance, error) {
...
func ReadTopologyInstances(instanceKeys []instmodel.InstanceKey) ([]*instmodel.Instance, error) {
	instances := make([]*instmodel.Instance, 0)
...
func RetryInstanceFunction(f func() (*instmodel.Instance, error)) (instance *instmodel.Instance, err error) {
...
func checkMaxScale(instance *instmodel.Instance, database *topology.Client, latency *stopwatch.NamedStopwatch) (isMaxScale bool, resolvedHostname string, err error) {
	...
	err = database.ReadDynamicRows("show variables like 'maxscale%'", func(m modeldomain.DynamicRow) error {
		if m.GetString("Variable_name") == "MAXSCALE_VERSION" {
			...
			instresolve.UpdateResolvedHostname(resolvedHostname, resolvedHostname)
...
func ExpectReplicationThreadsState(instance *instmodel.Instance, instanceKey *instmodel.InstanceKey, expectedState instmodel.ReplicationThreadState) (expectationMet bool, err error) {
	topologyDB, err := topology.Open(instanceKey.Hostname, instanceKey.Port)
	if err != nil {
		return false, err
	}
	err = topologyDB.ReadDynamicRows(mysqlquery.Query(instance.Version, mysqlquery.ShowSlaveStatus), func(m modeldomain.DynamicRow) error {
		ioThreadState := instmodel.ReplicationThreadStateFromStatus(m.GetString(mysqlquery.Query(instance.Version, mysqlquery.SlaveIORunning)))
		sqlThreadState := instmodel.ReplicationThreadStateFromStatus(m.GetString(mysqlquery.Query(instance.Version, mysqlquery.SlaveSQLRunning)))
...
func ReadTopologyInstanceBufferable(instanceKey *instmodel.InstanceKey, bufferWrites bool, latency *stopwatch.NamedStopwatch) (*instmodel.Instance, bool, error) {
...
func ReadTopologyInstanceBufferableContext(ctx context.Context, instanceKey *instmodel.InstanceKey, bufferWrites bool, latency *stopwatch.NamedStopwatch) (inst *instmodel.Instance, skipped bool, err error) {
	...
	var masterKey *instmodel.InstanceKey

	if !instanceKey.IsValid() {
		latency.Start("backend")
		if err := instinventory.UpdateInstanceLastAttemptedCheck(instanceKey); err != nil {
	...
	if isMaxScale, resolvedHostname, err = checkMaxScale(instance, topologyDB, latency); err != nil {
	...
	instance.ReplicationIOThreadState = instmodel.ReplicationThreadStateNoThread
	instance.ReplicationSQLThreadState = instmodel.ReplicationThreadStateNoThread
	...
	err = topologyDB.ReadDynamicRowsContext(ctx, mysqlquery.Query(instance.Version, mysqlquery.ShowSlaveStatus), func(m modeldomain.DynamicRow) error {
		...
		instance.ReplicationIOThreadState = instmodel.ReplicationThreadStateFromStatus(m.GetString(mysqlquery.Query(instance.Version, mysqlquery.SlaveIORunning)))
		instance.ReplicationSQLThreadState = instmodel.ReplicationThreadStateFromStatus(m.GetString(mysqlquery.Query(instance.Version, mysqlquery.SlaveSQLRunning)))
		instance.ReplicationIOThreadRuning = instance.ReplicationIOThreadState.IsRunning()
		if isMaxScale110 {
			// Covering buggy MaxScale 1.1.0
			instance.ReplicationIOThreadRuning = instance.ReplicationIOThreadRuning && (m.GetString(mysqlquery.Query(instance.Version, mysqlquery.SlaveIOState)) == "Binlog Dump")
		}
		instance.ReplicationSQLThreadRuning = instance.ReplicationSQLThreadState.IsRunning()
		instance.ReadBinlogCoordinates.LogFile = m.GetString(mysqlquery.Query(instance.Version, mysqlquery.MasterLogFile))
		instance.ReadBinlogCoordinates.LogPos = m.GetInt64(mysqlquery.Query(instance.Version, mysqlquery.ReadMasterLogPos))
		instance.ExecBinlogCoordinates.LogFile = m.GetString(mysqlquery.Query(instance.Version, mysqlquery.RelayMasterLogFile))
		instance.ExecBinlogCoordinates.LogPos = m.GetInt64(mysqlquery.Query(instance.Version, mysqlquery.RelayMasterLogPosition))
		...
		instance.MasterUUID = m.GetStringD(mysqlquery.Query(instance.Version, mysqlquery.MasterUUID), "No")
		...
		masterHostnameTmp = m.GetString(mysqlquery.Query(instance.Version, mysqlquery.MasterHost))
		if isMaxScale110 {
			// Buggy buggy maxscale 1.1.0. Reported Master_Host can be corrupted.
			// Therefore we (currently) take @@hostname (which is masquarading as master host anyhow)
			masterHostnameTmp = maxScaleMasterHostname
		}
		masterPortTmp = m.GetInt(mysqlquery.Query(instance.Version, mysqlquery.MasterPort))

		instance.IsDetachedMaster = instance.MasterKey.IsDetached()
		instance.SecondsBehindMaster = modeldomain.NullInt64(m.GetNullInt64(mysqlquery.Query(instance.Version, mysqlquery.SecondsBehindMaster)))
		...
		instance.AllowTLS = (m.GetString(mysqlquery.Query(instance.Version, mysqlquery.MasterSSLAllowed)) == "Yes")
	...
	if !isMaxScale {
		...
		err = topologyDB.ReadRowContext(ctx, "select @@global.hostname, ifnull(@@global.report_host, ''), @@global.server_id, @@global.version_comment, @@global.read_only, @@global.binlog_format, @@global.log_bin, @@global."+mysqlquery.Query(instance.Version, mysqlquery.LogSlaveUpdates)).Decode(
		...
		if instance.LogBinEnabled {
			waitGroup.Go(func() {
				err := topologyDB.ReadDynamicRowsContext(ctx, mysqlquery.Query(instance.Version, mysqlquery.ShowMasterStatus), func(m modeldomain.DynamicRow) error {
					var err error
		...
		if (instance.IsOracleMySQL() || instance.IsPercona()) && !instance.IsSmallerMajorVersionByString("5.6") {
			...
			go func() {
				...
				_ = topologyDB.ReadRowContext(ctx, mysqlquery.Query(instance.Version, mysqlquery.MasterGTIDInfo)).Decode(&instance.GTIDMode, &instance.ServerUUID, &instance.ExecutedGtidSet, &instance.GtidPurged, &masterInfoRepositoryOnTable, &instance.BinlogRowImage)
	...
	if resolvedHostname != instance.Key.Hostname {
		latency.Start("backend")
		instresolve.UpdateResolvedHostname(instance.Key.Hostname, resolvedHostname)
		latency.Stop("backend")
	...
	if slaveStatusFound {
		...
		masterKey, err = instresolve.NewInstanceKey(masterHostnameTmp, masterPortTmp)
		if err != nil {
			logReadTopologyInstanceError(instanceKey, "NewResolveInstanceKey", err)
		}
		masterKey.Hostname, resolveErr = instresolve.ResolveHostname(masterKey.Hostname)
		if resolveErr != nil {
	...
	if !foundByShowSlaveHosts && !isMaxScale {
		...
		waitGroup.Go(func() {
			err := topologyDB.ReadDynamicRowsContext(ctx, mysqlquery.Query(instance.Version, mysqlquery.SelectUserHost),
				func(m modeldomain.DynamicRow) error {
					cname, resolveErr := instresolve.ResolveHostname(m.GetString("slave_hostname"))
					user := m.GetString("user")
					if resolveErr != nil {
	...
	if instance.IsNDB() {
		...
		waitGroup.Go(func() {
			...
			`,
				func(m modeldomain.DynamicRow) error {
					cname, resolveErr := instresolve.ResolveHostname(m.GetString("mysql_host"))
					if resolveErr != nil {
	...
	{
		latency.Start("backend")
		err = instinventory.ReadInstanceClusterAttributes(instance)
		latency.Stop("backend")
	...
	{
		latency.Start("backend")
		err = instinventory.ReadInstancePromotionRule(instance)
		latency.Stop("backend")
	...
	if config.Config.Topology.Classification.DetectPromotionRuleQuery != "" && !isMaxScale {
		waitGroup.Go(func() {
			...
			if err == nil {
				...
				err = instcandidate.RegisterCandidateInstance(instcandidate.NewCandidateDatabaseInstance(instanceKey, promotionRule).WithCurrentTime())
				logReadTopologyInstanceError(instanceKey, "RegisterCandidateInstance", err)
			}
		})
	}

	instinventory.ReadClusterAliasOverride(instance)
	if !isMaxScale {
		...
		if instance.SuggestedClusterAlias == "" {
			...
			if clusterAlias := instcluster.MappedNameToAlias(instance.ClusterName); clusterAlias != "" {
				instance.SuggestedClusterAlias = clusterAlias
			}
		}
	}
	if instance.ReplicationDepth == 0 && config.Config.Topology.Classification.DetectClusterDomainQuery != "" && !isMaxScale {
		...
		if domainName != "" {
			latency.Start("backend")
			err := instcluster.WriteClusterDomainName(instance.ClusterName, domainName)
			latency.Stop("backend")
...
Cleanup:
	...
	if instanceFound {
		...
		if instance.ExecutedGtidSet != "" && instance.MasterExecutedGtidSet() != "" {
			...
			redactedExecutedGtidSet, _ := gtid.NewOracleGtidSet(instance.ExecutedGtidSet)
			...
			if !redactedExecutedGtidSet.IsEmpty() {
				redactedMasterExecutedGtidSet, _ := gtid.NewOracleGtidSet(instance.MasterExecutedGtidSet())
	...
	if instanceFound {
		...
		latency.Start("backend")
		if bufferWrites {
			instinventory.EnqueueInstanceWrite(instance, instanceFound, err)
		} else {
	...
	if !instanceDiscoverySkipped {
		latency.Start("backend")
		_ = instinventory.UpdateInstanceLastChecked(&instance.Key, partialSuccess)
		latency.Stop("backend")
	}
