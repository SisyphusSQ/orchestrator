...
func ReadInstancePromotionRule(instance *Instance) (err error) {
	...
	if err == nil && len(rows) > 0 {
		promotionRule = CandidatePromotionRule(rows[0])
	}
...
func readInstanceRow(row modeldomain.BackendInstanceRecord) *Instance {
...
func readInstances(readRows instanceRowsReader) ([]*Instance, error) {
