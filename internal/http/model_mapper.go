...
func instanceKeyVO(value inst.InstanceKey) vo.InstanceKey {
	return vo.InstanceKey{Hostname: value.Hostname, Port: value.Port}
}

func instanceKeysVO(values []inst.InstanceKey) []vo.InstanceKey {
	if values == nil {
		return nil
	}
...
func instanceKeyMapVO(values inst.InstanceKeyMap) []vo.InstanceKey {
	return instanceKeysVO(values.GetInstanceKeys())
}

func binlogCoordinatesVO(value inst.BinlogCoordinates) vo.BinlogCoordinates {
	return vo.BinlogCoordinates{LogFile: value.LogFile, LogPos: value.LogPos, Type: int(value.Type)}
}

func clusterInfoVO(value inst.ClusterInfo) vo.ClusterInfo {
...
func instanceVO(value *inst.Instance) *vo.Instance {
	if value == nil {
		return nil
	}
	return &vo.Instance{
...
func instancesVO(values []*inst.Instance) []*vo.Instance {
	if values == nil {
		return nil
	}
...
func instanceValuesVO(values []inst.Instance) []vo.Instance {
	if values == nil {
		return nil
	}
	result := make([]vo.Instance, 0, len(values))
...
func clusterInfosVO(values []inst.ClusterInfo) []vo.ClusterInfo {
	if values == nil {
		return nil
	}
...
func replicationAnalysisVO(value inst.ReplicationAnalysis) vo.ReplicationAnalysis {
...
func replicationAnalysesVO(values []inst.ReplicationAnalysis) []vo.ReplicationAnalysis {
	if values == nil {
		return nil
	}
...
func topologyRecoveryVO(value *logic.TopologyRecovery) *vo.TopologyRecovery {
	if value == nil {
		return nil
	}
...
func topologyRecoveriesVO(values []*logic.TopologyRecovery) []*vo.TopologyRecovery {
	if values == nil {
		return nil
	}
...
func blockedTopologyRecoveryVO(value logic.BlockedTopologyRecovery) vo.BlockedTopologyRecovery {
...
func blockedTopologyRecoveriesVO(values []logic.BlockedTopologyRecovery) []vo.BlockedTopologyRecovery {
	if values == nil {
		return nil
	}
...
func topologyRecoveryStepVO(value logic.TopologyRecoveryStep) vo.TopologyRecoveryStep {
	return vo.TopologyRecoveryStep{Id: value.Id, RecoveryUID: value.RecoveryUID, AuditAt: value.AuditAt, Message: value.Message}
}

func topologyRecoveryStepsVO(values []logic.TopologyRecoveryStep) []vo.TopologyRecoveryStep {
	if values == nil {
		return nil
	}
...
func writeHTTPJSON(r Responder, status int, value any) {
